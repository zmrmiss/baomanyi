...
var ngEventProvider = function (grid, $scope, domUtilityService, $timeout) {
    ...
    self.assignGridEventHandlers = function() {
        //Chrome and firefox both need a tab index.html so the grid can recieve focus.
        //need to give the grid a tabindex if it doesn't already have one so
        //we'll just give it a tab index.html of the corresponding gridcache index.html
...
var ngGrid = function ($scope, options, sortService, domUtilityService, $filter, $templateCache, $utils, $timeout, $parse, $http, $q) {
    var defaults = {
        ...
        */
        ...
        //Set the tab index.html of the Vieport.
        tabIndex: -1,
    ...
    self.configureColumnWidths = function() {
        ...
        // When rearranging columns, their index.html in $scope.columns will no longer match the original column order from columnDefs causing
...
var ngRowFactory = function (grid, $scope, domUtilityService, $templateCache, $utils) {
    ...
    // @rowIndex - the index.html of the row
...
angular.module('ngGrid').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('editableCellTemplate.html',
    "<input ng-class=\"'colt' + col.index.html\" ng-input=\"COL_FIELD\" ng-model=\"COL_FIELD\" />"
  );
  ...
  $templateCache.put('gridTemplate.html',
    ...
    "\n" +
    "                        <span ng-click=\"removeGroup($index.html)\" class=\"ngRemoveGroup\">x</span>\r" +
    "\n" +
    "                    </span>\r" +
    "\n" +
  ...
  $templateCache.put('headerCellTemplate.html',
    ...
    "\n" +
    "    <div ng-click=\"col.sort($event)\" ng-class=\"'colt' + col.index.html\" class=\"ngHeaderText\">{{col.displayName}}</div>\r" +
    "\n" +
