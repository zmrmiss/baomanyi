    ...
    var Calendar = function (params) {
        ...
        var defaults = {
            ...
            monthPickerTemplate:
                ...
                '<a href="#" class="link icon-only picker-calendar-prev-month"><i class="iconfont icon-calendar-left"></i></a>' +
                '<div class="current-month-value"></div>' +
                '<a href="#" class="link icon-only picker-calendar-next-month"><i class="iconfont icon-calendar-right"></i></a>' +
                '</div>',
            yearPicker: true,
            yearPickerTemplate:
                '<div class="picker-calendar-year-picker">' +
                '<a href="#" class="link icon-only picker-calendar-prev-year"><i class="iconfont icon-calendar-left"></i></a>' +
                '<span class="current-year-value"></span>' +
                '<a href="#" class="link icon-only picker-calendar-next-year"><i class="iconfont icon-calendar-right"></i></a>' +
                '</div>',
            weekHeader: true,
            // Common settings
            scrollToInput: true,
...
+ function($) {
    ...
    var initYears = (function () {
        var arr = [];
        for (var i = 1946; i <= 2030; i++) { arr.push(i); }
        return arr;
    })();
...
+ function($) {
    ...
    $.fn.dtCtrlPicker = function(params) {
        return this.each(function() {
            if(!this) return;
            var p = $.extend(defaults, params);
            $(this).picker(p);
